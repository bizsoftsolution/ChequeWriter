Public Class frmEnvelopeSearchNew
    ...
    Private Sub frmEnvelopeSearch_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles pnlContent.Resize

        Dim l, t As Integer
        l = (pnlContent.Width - dgvEnvelope.Width) / 2
        If l < 0 Then l = 0
        t = (pnlContent.Height - dgvEnvelope.Height) / 2
        If t < 0 Then t = 0
        dgvEnvelope.Left = l
