Public Class frmEnvelopeReport

    Private Sub frmEnvelopeReport_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
    ...
    Sub ViewSearch()
        ...
        DTEnvelope = db.EnvelopeSize.Grid("*", WQry).ToTable("EnvelopeSize")

        ds.Clear()
        ds.Tables.Add(DTEnvelope)
        ReportViewMain(CrystalReportViewer1, "cryEnvelopeSize.rpt", ds, Nothing)
    End Sub
    Private Sub btnExit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExit.Click
        SendKeys.Send("{ESCAPE}")
    End Sub

    Private Sub frmEnvelopeReport_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
        Dim l, t As Integer
